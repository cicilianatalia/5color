package com.cici202102320.recyclerview;
...
public class MainActivity extends AppCompatActivity {
    private FloatingActionButton _addButon;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _recyclerView1 = (RecyclerView) findViewById(R.id.recyclearView1);
    ...
    private void initAddButton() {
        _addButon = findViewById(R.id.addButton);

        _addButon.setOnClickListener(new View.OnClickListener() {
            @Override
