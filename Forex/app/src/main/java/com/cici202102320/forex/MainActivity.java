package com.cici202102320.forex;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadingProgressBar = (ProgressBar)findViewById(R.id.loadingProgresBar);
    ...
    private void initForex() {
        ...
        String url = "https://openexchangerates.org/api/latest.json?app_id=67b81700b2cd4de3b87f3a3d49ce9599";

        AsyncHttpClient asynHttpClient = new AsyncHttpClient();
        asynHttpClient.get(url, new AsyncHttpResponseHandler() {
            @Override
